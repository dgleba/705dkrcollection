...
class HTMXMenu0ListView(generic.ListView):
    model = models.Menu0
...
class HTMXMenu0CreateView(generic.CreateView):
    model = models.Menu0
    form_class = forms.Menu0Form
...
class HTMXMenu0DeleteView(generic.DeleteView):
    model = models.Menu0
    success_url = reverse_lazy("app_Menu0_htmx_list")

...
class HTMXApostListView(generic.ListView):
    model = models.Apost
...
class HTMXApostCreateView(generic.CreateView):
    model = models.Apost
    form_class = forms.ApostForm
...
class HTMXApostDeleteView(generic.DeleteView):
    model = models.Apost
    success_url = reverse_lazy("blogapp_Apost_htmx_list")

...
class HTMXMenumodelListView(generic.ListView):
...
class HTMXMenumodelCreateView(generic.CreateView):
    model = models.Menumodel
    form_class = forms.MenumodelForm
...
class HTMXMenumodelDeleteView(generic.DeleteView):
    model = models.Menumodel
    success_url = reverse_lazy("menuapp1_Menumodel_htmx_list")

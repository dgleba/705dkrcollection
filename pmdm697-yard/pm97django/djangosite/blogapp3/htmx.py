...
class HTMXPost3ListView(generic.ListView):
    model = models.Post3
...
class HTMXPost3CreateView(generic.CreateView):
    model = models.Post3
    form_class = forms.Post3Form
...
class HTMXPost3DeleteView(generic.DeleteView):
    model = models.Post3
    success_url = reverse_lazy("blogapp3_Post3_htmx_list")
